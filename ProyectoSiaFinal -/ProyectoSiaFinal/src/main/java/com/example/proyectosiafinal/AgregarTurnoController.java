...
public class AgregarTurnoController implements Initializable {
    ...
    @FXML private TextField tfHorarioTurno;              // Ej: "DIA" o "NOCHE"
    @FXML private TextField tfCapacidadEnfermerasTurno;  // entero > 0
    ...
    private void onAgregar(ActionEvent event) {
        ...
        // Normaliza horario (opcional): acepta "DIA" / "NOCHE"
        ...
        // Buscar el objeto Area existente
