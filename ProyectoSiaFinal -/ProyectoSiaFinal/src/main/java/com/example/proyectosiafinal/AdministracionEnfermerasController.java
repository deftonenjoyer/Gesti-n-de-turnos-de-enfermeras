...
public class AdministracionEnfermerasController {
    ...
    private void initialize() {
        ...
        btnReporte.setOnAction(e -> abrirVentana("ReporteAsistencia.fxml", "Reporte Asistencia"));
    ...
    private void abrirVentana(String fxml, String titulo) {
        try {
            ...
            } /*else if (controller instanceof ReporteAsistenciaController) {
                ((ReporteAsistenciaController) controller).setSistemaHospital(sistemaHospital);
            }*/
